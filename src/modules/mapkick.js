...
(function (global, factory) {
  ...
  const BaseMap = function BaseMap(element, data, options, mapType) {
    const this$1$1 = this;
    ...
    function extendBounds(bounds, geometry) {
      if (geometry.type === "Point") {
        ...
        const coordinates$1 = geometry.coordinates;
        for (let j$1 = 0; j$1 < coordinates$1.length; j$1++) {
          const polygon = coordinates$1[j$1][0];
  ...
  const Map = /* @__PURE__ */(function (BaseMap) {
  ...
  const AreaMap = /* @__PURE__ */(function (BaseMap) {
